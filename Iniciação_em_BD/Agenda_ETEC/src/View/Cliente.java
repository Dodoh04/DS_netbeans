...
@NamedQueries({
    ...
    , @NamedQuery(name = "Cliente.findByCliNime", query = "SELECT c FROM Cliente c WHERE c.cliNime = :cliNime")
...
public class Cliente implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "cli_nime")
    private String cliNime;
    ...
    public Cliente(Integer cliCod, String cliNime) {
        this.cliCod = cliCod;
        this.cliNime = cliNime;
    }
    ...
    public String getCliNime() {
        return cliNime;
    }

    public void setCliNime(String cliNime) {
        String oldCliNime = this.cliNime;
        this.cliNime = cliNime;
        changeSupport.firePropertyChange("cliNime", oldCliNime, cliNime);
    }
